					...
					try {
						...
						if (!startBookingDay.isValidDate()) {
							...
							if (hike.equals("beaten")) {
								rates = new Rates(com.lcourtn5.maven.Rates.HIKE.BEATEN);
							} else if (hike.equals("hellroaring")) {
								rates = new Rates(com.lcourtn5.maven.Rates.HIKE.HELLROARING);
							} else if (hike.equals("gardiner")){
								rates = new Rates(com.lcourtn5.maven.Rates.HIKE.GARDINER);
							}
							if (rates != null) {
